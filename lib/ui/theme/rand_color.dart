...
class ColorR extends Color {
  ...
  return HSVColor.fromAHSV(
    ...
    0.8 + random.nextDouble() * 0.2, // Saturación (0.8-1.0 para colores vivos)
    0.8 + random.nextDouble() * 0.2, // Brillo (0.8-1.0 para evitar tonos oscuros)
  ).toColor();
}
