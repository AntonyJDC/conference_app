...
class ReviewStarAnimationWidget extends StatefulWidget {
  final VoidCallback onComplete;
  final Offset targetPosition;

  const ReviewStarAnimationWidget({
    super.key,
  ...
  @override
  ReviewStarAnimationWidgetState createState() =>
      ReviewStarAnimationWidgetState();
}

class ReviewStarAnimationWidgetState extends State<ReviewStarAnimationWidget>
        ...
        return Positioned(
          ...
          child: Opacity(
            ...
            child: Transform.scale(
              ...
              child: Icon(Icons.star, color: Colors.green, size: 100),
            ),
          ),
        );
      },
